"""
train embedding with Softmax Loss
Author: LucasX
"""
import copy
import os
...
def run_tissue_physiology_recognition(model, epoch):
    """
    run tissue physiology recognition
    :param model:
    :param epoch:
    :return:
    """
    ...
    print('start loading TissuePhysiologyDataset...')
...
def run_light_clothing_recognition(model, epoch):
    """
    run light clothing recognition
    :param model:
    :param epoch:
    :return:
    """
    ...
    print('start loading LightClothingDataset...')
...
if __name__ == '__main__':
    ...
    # efficientnet = EfficientNet.from_pretrained('efficientnet-b6', num_classes=6)

    # run_tissue_physiology_recognition(model=densenet169, epoch=cfg['epoch'])
    run_light_clothing_recognition(model=densenet121, epoch=cfg['epoch'])
