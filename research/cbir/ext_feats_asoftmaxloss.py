...
if __name__ == '__main__':
    product_middle_class = 'TissuePhysiology'

    if product_middle_class == 'LightClothing':
        out_num = 65
    elif product_middle_class == 'TissuePhysiology':
        out_num = 333
    densenet121 = DenseNet121(num_cls=out_num)

    state_dict = torch.load('/data/lucasxu/ModelZoo/DenseNet121_{}_Embedding_AngularLoss.pth'.format(product_middle_class))
    try:
