...
def run_image_quality_assessment(model, epoch):
    """
    ...
    trainloader, valloader, testloader = data_loader.load_image_quality_data()
...
if __name__ == '__main__':
    ...
    run_image_quality_assessment(model=iqanet, epoch=cfg['epoch'])
