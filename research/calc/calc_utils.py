...
if __name__ == '__main__':
    df = pd.read_csv("C:/Users/Administrator/Desktop/ResNet.csv")
    gts = df['gt']
    preds = df['pred']

    print('Top1 Acc = %f' % accuracy_score(gts, preds))
    ...
    plot_confusion_matrix(gts, preds, classes=['duidie', 'zhengchang', 'zhuguonei'], normalize=True,
                          title='Normalized confusion matrix')
    plt.show()
